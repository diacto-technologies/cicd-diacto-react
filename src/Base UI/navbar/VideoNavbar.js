                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start rtl:justify-end">
                            ...
                            <Link to={`/app/user/jobs/`} className="flex ms-2 md:me-24">
                                ...
                                <span className="self-center text-xl font-semibold  leading-3 text-primary-600 sm:text-2xl whitespace-nowrap ">CandidHR</span>
                            </Link>
                        </div>
                        <div className="flex items-center">
                            <div className="flex items-center ms-3">
                                <Menu as="div" className="relative ml-3  flex items-center">
                                    <label className='text-sm me-1'>{candidateDetails?.name}</label>
                                    <Menu.Button className="inline-flex items-center rounded-full 1 mx-2 text-sm font-semibold text-gray-900 shadow-md ">
                                        <img className="w-8 h-8 rounded-full" src={candidateDetails?.profile_pic ? candidateDetails?.profile_pic : "https://images.pexels.com/photos/1080213/pexels-photo-1080213.jpeg?auto=compress&cs=tinysrgb&w=600"} alt="Avatar" />
                                    </Menu.Button>
