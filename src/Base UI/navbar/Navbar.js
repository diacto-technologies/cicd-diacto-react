          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                ...
                <label className='text-sm me-1'>{userDetails?.name}</label>
                  <Menu.Button className="inline-flex items-center rounded-full 1 mx-2 text-sm font-semibold text-gray-900 shadow-md ">
                    <img className="w-8 h-8 rounded-full" src={userDetails?.profile_pic ? userDetails?.profile_pic : DefaultImg} alt="Avatar" />
                  </Menu.Button>
